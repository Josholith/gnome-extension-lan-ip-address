...
function _get_lan_ip() {
    ...
    for (let current_character_index = 0;
         current_character_index < command_output_bytes.length;
         ++current_character_index) {
        const current_character = String.fromCharCode(command_output_bytes[current_character_index]);
...
let LanIPAddressIndicator = class LanIPAddressIndicator extends PanelMenu.Button {
